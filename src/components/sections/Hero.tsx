      ...
      <div className="container-wide relative z-10 pt-20 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center min-h-[70vh]">
          ...
          <div className="lg:col-span-5 space-y-8">
            {/* 小标签 */}
            <div className="flex items-end gap-4 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              <img src="/picture/logoBlv.png" alt="印章" className="w-12 h-12 object-contain relative top-6" />
              <span className="text-caption tracking-widest relative top-7 -left-2">山海经神兽系列</span>
            </div>
